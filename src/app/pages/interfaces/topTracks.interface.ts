// To parse this data:
//
//   import { Convert, TopTracks } from "./file";
//
//   const topTracks = Convert.toTopTracks(json);
//
...
export class Convert {
    public static toTopTracks(json: string): TopTracks {
        return cast(JSON.parse(json), r("TopTracks"));
    }

    public static topTracksToJson(value: TopTracks): string {
        return JSON.stringify(uncast(value, r("TopTracks")), null, 2);
    }
}
